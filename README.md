...
[![m-schmailzl/simple-reverse-proxy](https://img.shields.io/badge/m--schmailzl%2Fsimple--reverse--proxy-gray?logo=github)](https://github.com/m-schmailzl/simple-reverse-proxy)

![Build Status](https://img.shields.io/github/actions/workflow/status/m-schmailzl/simple-reverse-proxy/docker-publish.yml?branch=main)
...
The container is meant to be used with another reverse proxy which handles encryption (e.g. [nginxproxy/nginx-proxy](https://hub.docker.com/r/nginxproxy/nginx-proxy/)).
